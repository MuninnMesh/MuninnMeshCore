...
// demo code and our battle-tested LR2021F33 profile (munnin-lr2021-rs:
// "RF switch state: LF TX asserted only").
...
bool radio_init() {
  ...
  // ---- Radio is the product: bring the LoRa front-end up FIRST. The I2C
  // sensor/RTC discovery is deliberately moved AFTER radio.begin() (below) so a
  // flaky or unpowered I2C bus can never delay or block the radio coming up. ----
